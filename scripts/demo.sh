...
echo "🚀 Starting 3-node mesh demo..."

# Node 1: Laptop (Hub — GPU enabled, strongest)
...
# Node 2: Phone (Client — no GPU, delegates inference)
...
# Node 3: Raspberry Pi (RAG node — handles embeddings)
...
# Wait for interrupt
trap "echo ''; echo '🛑 Stopping demo nodes...'; kill $PID1 $PID2 $PID3 2>/dev/null; exit 0" INT
wait
